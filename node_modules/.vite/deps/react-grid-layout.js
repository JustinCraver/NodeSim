...
// node_modules/react-grid-layout/node_modules/react-draggable/build/cjs/Draggable.js
var require_Draggable = __commonJS({
  "node_modules/react-grid-layout/node_modules/react-draggable/build/cjs/Draggable.js"(exports, module) {
    "use strict";
    ...
    var import_clsx3 = require_clsx();
    function findInArray2(array, callback) {
    ...
    function getPrefix2(prop = "transform") {
      ...
      for (let i = 0; i < prefixes2.length; i++) {
        if (browserPrefixToKey2(prop, prefixes2[i]) in style)
          return prefixes2[i];
      }
      return "";
    }
    ...
    function matchesSelectorAndParentsTo2(el, selector, baseNode) {
      let node = el;
      do {
        if (matchesSelector2(node, selector))
          return true;
        if (node === baseNode)
          return false;
    ...
    function addUserSelectStyles2(doc) {
      ...
      if (doc.body)
        addClassName2(doc.body, "react-draggable-transparent-selection");
    }
    ...
    function removeUserSelectStyles2(doc) {
      ...
      try {
        if (doc.body)
          removeClassName2(doc.body, "react-draggable-transparent-selection");
    ...
    function getBoundPosition2(draggable, x, y) {
      ...
      if (isNum2(bounds.right))
        x = Math.min(x, bounds.right);
      if (isNum2(bounds.bottom))
        y = Math.min(y, bounds.bottom);
      if (isNum2(bounds.left))
        x = Math.max(x, bounds.left);
      if (isNum2(bounds.top))
    ...
    var DraggableCore2 = class extends React3.Component {
      constructor() {
        super(...arguments);
        this.dragging = false;
        this.lastX = NaN;
        ...
        this.handleDragStart = (e) => {
          ...
          if (!this.props.allowAnyClick && (typeof e.button === "number" && e.button !== 0 || e.ctrlKey))
            return false;
          ...
          if (this.props.enableUserSelectHack)
            addUserSelectStyles2(ownerDocument);
          this.dragging = true;
          this.lastX = x;
          this.lastY = y;
        ...
        this.handleDragStop = (e) => {
          ...
          if (thisNode) {
            if (this.props.enableUserSelectHack)
              scheduleRemoveUserSelectStyles2(thisNode.ownerDocument);
          }
      ...
      componentWillUnmount() {
        ...
        if (thisNode) {
          ...
          if (this.props.enableUserSelectHack)
            scheduleRemoveUserSelectStyles2(ownerDocument);
        }
      }
    ...
    var Draggable2 = class extends React23.Component {
      ...
      render() {
        ...
        const className = (0, import_clsx3.clsx)(onlyChild.props.className || "", defaultClassName, {
          [defaultClassNameDragging]: this.state.dragging,
          [defaultClassNameDragged]: this.state.dragged
        });
        return React23.createElement(DraggableCore2, { ...draggableCoreProps, onStart: this.onDragStart, onDrag: this.onDrag, onStop: this.onDragStop }, React23.cloneElement(onlyChild, {
          className,
...
// node_modules/react-grid-layout/node_modules/react-draggable/build/cjs/cjs.js
var require_cjs = __commonJS({
  "node_modules/react-grid-layout/node_modules/react-draggable/build/cjs/cjs.js"(exports, module) {
    "use strict";
...
// node_modules/react-grid-layout/node_modules/react-resizable/build/utils.js
var require_utils = __commonJS({
  "node_modules/react-grid-layout/node_modules/react-resizable/build/utils.js"(exports) {
    "use strict";
...
// node_modules/react-grid-layout/node_modules/react-resizable/build/propTypes.js
var require_propTypes = __commonJS({
  "node_modules/react-grid-layout/node_modules/react-resizable/build/propTypes.js"(exports) {
    "use strict";
    exports.__esModule = true;
...
var require_Resizable = __commonJS({
  "node_modules/react-grid-layout/node_modules/react-resizable/build/Resizable.js"(exports) {
    "use strict";
    exports.__esModule = true;
    ...
    function _interopRequireWildcard(e, t) {
      if ("function" == typeof WeakMap)
        var r2 = /* @__PURE__ */ new WeakMap(), n = /* @__PURE__ */ new WeakMap();
      return (_interopRequireWildcard = function(e2, t2) {
        ...
        for (const t3 in e2)
          "default" !== t3 && {}.hasOwnProperty.call(e2, t3) && ((i = (o = Object.defineProperty) && Object.getOwnPropertyDescriptor(e2, t3)) && (i.get || i.set) ? o(f, t3, i) : f[t3] = e2[t3]);
        return f;
      })(e, t);
    }
    function _extends() {
    ...
    var Resizable2 = class extends React3.Component {
      constructor() {
        super(...arguments);
        this.handleRefs = {};
      ...
      renderResizeHandle(handleAxis, ref) {
        ...
        return React3.cloneElement(handle, props);
      }
      render() {
        ...
        return (0, _utils.cloneElement)(children, _objectSpread(_objectSpread({}, p), {}, {
          ...
          children: [...React3.Children.toArray(children.props.children), ...resizeHandles.map((handleAxis) => {
            var _this$handleRefs$hand;
            const ref = (_this$handleRefs$hand = this.handleRefs[handleAxis]) != null ? _this$handleRefs$hand : this.handleRefs[handleAxis] = React3.createRef();
            return React3.createElement(_reactDraggable.DraggableCore, _extends({}, draggableOpts, {
              nodeRef: ref,
...
var require_ResizableBox = __commonJS({
  "node_modules/react-grid-layout/node_modules/react-resizable/build/ResizableBox.js"(exports) {
    "use strict";
    exports.__esModule = true;
    exports.default = void 0;
    var React3 = _interopRequireWildcard(require_react());
    ...
    var ResizableBox = class extends React3.Component {
      constructor() {
        super(...arguments);
        this.state = {
      ...
      render() {
        ...
        return React3.createElement(_Resizable.default, {
          axis,
          draggableOpts,
          handle,
          handleSize,
        ...
        }, React3.createElement("div", _extends({}, props, {
...
var require_react_resizable = __commonJS({
  "node_modules/react-grid-layout/node_modules/react-resizable/index.js"(exports, module) {
    "use strict";
...
function getCompactor(compactType, allowOverlap = false, preventCollision = false) {
  ...
  if (allowOverlap) {
    if (compactType === "vertical")
      baseCompactor = verticalOverlapCompactor;
    else if (compactType === "horizontal")
      baseCompactor = horizontalOverlapCompactor;
    else
      baseCompactor = noOverlapCompactor;
  } else {
    if (compactType === "vertical")
      baseCompactor = verticalCompactor;
    else if (compactType === "horizontal")
      baseCompactor = horizontalCompactor;
    else
      baseCompactor = noCompactor;
  }
  if (preventCollision) {
...
// node_modules/react-grid-layout/dist/chunk-PZLKKWSX.mjs
...
// node_modules/react-grid-layout/node_modules/react-draggable/build/cjs/chunk-D5BXCJ5G.mjs
...
function childrenEqual(a, b) {
  ...
  for (let i = 0; i < aArr.length; i++) {
    const aChild = aArr[i];
    const bChild = bArr[i];
    if ((aChild == null ? void 0 : aChild.key) !== (bChild == null ? void 0 : bChild.key))
      return false;
  }
  return true;
}
function synchronizeLayoutWithChildren(initialLayout, children, cols, compactor) {
  ...
  import_react2.default.Children.forEach(children, (child) => {
    if (!import_react2.default.isValidElement(child) || child.key === null)
      return;
...
function GridLayout(props) {
  ...
  const handleDragOver = (0, import_react2.useCallback)(
    (e) => {
      ...
      e.preventDefault();
      e.stopPropagation();
      if (isFirefox && !((_a = e.nativeEvent.target) == null ? void 0 : _a.classList.contains(
        layoutClassName
      ))) {
        return false;
      }
